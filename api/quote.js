...
export default async function handler(req,res){
  ...
  const {service,location,date,duration,name,company,email,phone,details,website}=req.body||{};
  ...
  const fields={Service:service,Location:location,'Start date':date,Duration:duration,Name:name,Company:company,Email:email,Phone:phone,Details:details};
